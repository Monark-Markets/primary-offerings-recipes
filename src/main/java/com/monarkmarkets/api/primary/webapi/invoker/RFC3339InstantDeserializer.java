package com.monarkmarkets.api.primary.webapi.invoker;
...
public class RFC3339InstantDeserializer<T extends Temporal> extends InstantDeserializer<T> {
    ...
    protected T _fromString(JsonParser p, DeserializationContext ctxt, String string0) throws IOException {
        ...
        if ("0001-01-01T00:00:00".equals(string0)) {
            return null; // or return a default value like OffsetDateTime.MIN
        }

        // Add Z if missing timezone info
        if (!string0.endsWith("Z") && !string0.contains("+") && string0.indexOf("-", 10) == -1) {
            string0 += "Z";
        }
